...
document.write(`You will be a ${selectedJobTitle} in ${selectedGeographicLocation}, and married to ${selectedPartnerName} with ${selectedNumberOfChildren} ${selectedNumberOfChildren > 1 ? 'kids' : 'kid'}.`);
